// File: src/components/CompanySidebar.js
"use client";
...
export default function CompanySidebar({ isCollapsed = false, setIsCollapsed }) {
  ...
  const navItems = [
    ...
    { name: 'Landing Page', icon: <Monitor size={18} />, hasSub: false },
    { name: 'System Users', icon: <Users size={18} />, hasSub: false },
    { name: 'Currency', icon: <DollarSign size={18} />, hasSub: false },
  ];
