      ...
      <main className="pt-32 pb-0 px-4 sm:px-8 lg:px-16 max-w-[1400px] mx-auto space-y-28 sm:space-y-36">
        ...
        <section className="space-y-16 lg:space-y-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            <div className="lg:col-span-6 space-y-6 text-left max-w-xl lg:max-w-none">
              ...
              <div className="pt-2"><Link href="/login" className="inline-flex items-center gap-2 border-2 border-[#0da777] px-6 py-3 rounded-xl text-sm font-bold text-[#0da777] hover:bg-[#0da777] hover:text-white transition-all"><span>▷</span> Login</Link></div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((test, idx) => (
              <div key={idx} className="bg-white border border-gray-100 p-6 sm:p-8 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.003)] text-left flex flex-col justify-between space-y-6 relative group hover:border-gray-200/80 transition-all duration-300">
                ...
                <p className="text-xs sm:text-sm font-semibold text-gray-600 leading-relaxed flex-1">
                  "{test.quote}"
                </p>
                <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                  <div className="w-10 h-10 rounded-full bg-[#0da777]/10 text-[#0da777] font-extrabold text-xs flex items-center justify-center uppercase">
                    {test.initial}
                  </div>
                  <div>
        ...
        <section className="space-y-12 max-w-3xl mx-auto pt-4 text-center">
          ...
          <div className="pt-8 space-y-4 flex flex-col items-center">
            <p className="text-sm font-semibold text-gray-500 tracking-tight">
              Still have questions?
            </p>
            <button className="bg-[#0da777] hover:bg-[#0b9368] active:scale-[0.99] text-white font-bold text-sm px-6 py-3 rounded-xl transition-all shadow-md shadow-[#0da777]/10 cursor-pointer">
              Contact Support
            </button>
          </div>
        </section>

        {/* ================= CORRECTION MAPPED: SUBSCRIPTION WIDGET SECTION (UPPER PLACEMENT) ================= */}
        <section className="max-w-3xl mx-auto bg-slate-50 border border-gray-150 p-8 sm:p-10 rounded-2xl shadow-sm text-center space-y-6">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto pt-2">
            ...
            />
            <button type="submit" className="bg-[#0da777] hover:bg-[#0b9368] text-white font-bold text-xs px-5 py-3 rounded-xl transition-all shadow-md shadow-[#0da777]/5 cursor-pointer">
              Subscribe
            </button>
          </form>
              ...
              <form onSubmit={handleSendMessage} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-900 font-medium focus:outline-none focus:border-[#0da777]"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-900 font-medium focus:outline-none focus:border-[#0da777] resize-none"
                  ></textarea>
                </div>

                <button type="submit" className="w-full bg-[#0da777] hover:bg-[#0b9368] text-white font-bold text-sm py-3 px-4 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-slate-50/60 border border-gray-100 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-800 mt-0.5">support@hrm.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50/60 border border-gray-100 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-800 mt-0.5">+1 (555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50/60 border border-gray-100 rounded-2xl">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Visit Us</h4>
                    <p className="text-sm font-bold text-gray-800 mt-0.5">San Francisco, CA</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-16 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 text-left">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-1.5 text-white">
              ...
              <span className="text-xl font-bold tracking-tight ml-0.5">RM</span>
            </div>
