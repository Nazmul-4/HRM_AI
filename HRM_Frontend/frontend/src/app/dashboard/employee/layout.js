// File: src/app/dashboard/employee/layout.js
"use client";
...
export default function EmployeeDashboardLayout({ children }) {
  ...
  const [userEmail, setUserEmail] = useState('employee@example.com');
  const [isLoading, setIsLoading] = useState(true);
  
  const [activeTab, setActiveTab] = useState('Dashboard');
  
  // Independent open/close menu state flags synchronized dynamically for the Employee view panel
    ...
    function verifySession() {
      if (typeof window !== 'undefined') {
        ...
        try {
          ...
          if (parsedUser && parsedUser.role && parsedUser.role.toLowerCase() === 'employee') {
  ...
  // Sync active UI tab and menu expansions dynamically on link parameters updates for employee route workspace
  useEffect(() => {
    if (pathname === '/dashboard/employee/employees') {
      setActiveTab('Employees');
    } else if (pathname === '/dashboard/employee') {
      setActiveTab('Dashboard');
    } else if (pathname === '/dashboard/employee/calendar') {
      setActiveTab('Calendar');
    } else if (pathname === '/dashboard/employee/media-library') {
      setActiveTab('Media Library');
    } else if (pathname.startsWith('/dashboard/employee/attendance/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/leave/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/payroll/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/performance/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/lifecycle/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/organization/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/recruitment/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/training/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/documents/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/meetings/')) {
    ...
    } else if (pathname.startsWith('/dashboard/employee/assets/')) {
  ...
  // Complete menu configuration array matching the HR dashboard workspace setup exactly
  const navItems = [
    { name: 'Dashboard', icon: <LayoutDashboard size={18} />, route: '/dashboard/employee', hasSub: false },
    { name: 'Employees', icon: <Users size={18} />, route: '/dashboard/employee/employees', hasSub: false },
    { 
      name: 'Attendance', 
      icon: <Clock size={18} />, 
      route: '#', 
      hasSub: true,
      subOptions: [
        { name: 'Attendance Records', route: '/dashboard/employee/attendance/records' },
        { name: 'Timesheet', route: '/dashboard/employee/attendance/timesheet' },
        { name: 'Attendance Regularizations', route: '/dashboard/employee/attendance/regularizations' },
        { name: 'Shifts', route: '/dashboard/employee/attendance/shifts' },
        { name: 'Attendance Policies', route: '/dashboard/employee/attendance/policies' }
      ]
    },
    { 
      ...
      hasSub: true,
      subOptions: [
        { name: 'Leave Applications', route: '/dashboard/employee/leave/applications' },
        { name: 'Leave Balances', route: '/dashboard/employee/leave/balances' },
        { name: 'Leave Types', route: '/dashboard/employee/leave/types' },
        { name: 'Leave Policies', route: '/dashboard/employee/leave/policies' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'Payslips', route: '/dashboard/employee/payroll/payslips' },
        { name: 'Payroll Runs', route: '/dashboard/employee/payroll/runs' },
        { name: 'Employee Salaries', route: '/dashboard/employee/payroll/salaries' },
        { name: 'Salary Components', route: '/dashboard/employee/payroll/components' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'Employee Reviews', route: '/dashboard/employee/performance/reviews' },
        { name: 'Employee Goals', route: '/dashboard/employee/performance/goals' },
        { name: 'Review Cycles', route: '/dashboard/employee/performance/cycles' },
        { name: 'Indicators', route: '/dashboard/employee/performance/indicators' },
        { name: 'Goal Types', route: '/dashboard/employee/performance/goal-types' },
        { name: 'Indicator Categories', route: '/dashboard/employee/performance/categories' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'Awards', route: '/dashboard/employee/lifecycle/awards' },
        { name: 'Promotions', route: '/dashboard/employee/lifecycle/promotions' },
        { name: 'Transfers', route: '/dashboard/employee/lifecycle/transfers' },
        { name: 'Warnings', route: '/dashboard/employee/lifecycle/warnings' },
        { name: 'Resignations', route: '/dashboard/employee/lifecycle/resignations' },
        { name: 'Terminations', route: '/dashboard/employee/lifecycle/terminations' },
        { name: 'Trips', route: '/dashboard/employee/lifecycle/trips' },
        { name: 'Complaints', route: '/dashboard/employee/lifecycle/complaints' }
      ]
    },
    { 
      ...
      hasSub: true,
      subOptions: [
        { name: 'Branches', route: '/dashboard/employee/organization/branches' },
        { name: 'Departments', route: '/dashboard/employee/organization/departments' },
        { name: 'Designations', route: '/dashboard/employee/organization/designations' },
        { name: 'Award Types', route: '/dashboard/employee/organization/award-types' },
        { name: 'Document Types', route: '/dashboard/employee/organization/document-types' },
        { name: 'Holidays', route: '/dashboard/employee/organization/holidays' },
        { name: 'Announcements', route: '/dashboard/employee/organization/announcements' }
      ]
    },
    {
      name: 'Recruitment',
      ...
      hasSub: true,
      subOptions: [
        { name: 'Job Categories', route: '/dashboard/employee/recruitment/categories' },
        { name: 'Job Types', route: '/dashboard/employee/recruitment/types' },
        { name: 'Job Locations', route: '/dashboard/employee/recruitment/locations' },
        { name: 'Job Postings', route: '/dashboard/employee/recruitment/postings' },
        { name: 'Candidate Sources', route: '/dashboard/employee/recruitment/sources' },
        { name: 'Candidates', route: '/dashboard/employee/recruitment/candidates' },
        { name: 'Interview Types', route: '/dashboard/employee/recruitment/interview-types' },
        { name: 'Interview Rounds', route: '/dashboard/employee/recruitment/interview-rounds' },
        { name: 'Interviews', route: '/dashboard/employee/recruitment/interviews' },
        { name: 'Interview Feedback', route: '/dashboard/employee/recruitment/feedback' },
        { name: 'Candidate Assessments', route: '/dashboard/employee/recruitment/assessments' },
        { name: 'Offer Templates', route: '/dashboard/employee/recruitment/offer-templates' },
        { name: 'Offers', route: '/dashboard/employee/recruitment/offers' },
        { name: 'Onboarding Checklists', route: '/dashboard/employee/recruitment/onboarding-checklists' },
        { name: 'Checklist Items', route: '/dashboard/employee/recruitment/checklist-items' },
        { name: 'Candidate Onboarding', route: '/dashboard/employee/recruitment/candidate-onboarding' },
        { name: 'Career', route: '/dashboard/employee/recruitment/career' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'Training Programs', route: '/dashboard/employee/training/programs' },
        { name: 'Employee Trainings', route: '/dashboard/employee/training/trainings' },
        { name: 'Training Sessions', route: '/dashboard/employee/training/sessions' },
        { name: 'Training Types', route: '/dashboard/employee/training/types' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'HR Documents', route: '/dashboard/employee/documents/hr-documents' },
        { name: 'Employee Contracts', route: '/dashboard/employee/documents/employee-contracts' },
        { name: 'Acknowledgments', route: '/dashboard/employee/documents/acknowledgments' },
        { name: 'Contract Types', route: '/dashboard/employee/documents/contract-types' },
        { name: 'Document Categories', route: '/dashboard/employee/documents/document-categories' },
        { name: 'Contract Templates', route: '/dashboard/employee/documents/contract-templates' },
        { name: 'Document Templates', route: '/dashboard/employee/documents/document-templates' }
      ]
    },
    {
      name: 'Meetings',
      ...
      hasSub: true,
      subOptions: [
        { name: 'Meeting Types', route: '/dashboard/employee/meetings/types' },
        { name: 'Meeting Rooms', route: '/dashboard/employee/meetings/rooms' },
        { name: 'Meetings', route: '/dashboard/employee/meetings/list' },
        { name: 'Meeting Attendees', route: '/dashboard/employee/meetings/attendees' },
        { name: 'Meeting Minutes', route: '/dashboard/employee/meetings/minutes' },
        { name: 'Action Items', route: '/dashboard/employee/meetings/action-items' }
      ]
    },
    {
      ...
      hasSub: true,
      subOptions: [
        { name: 'Assets', route: '/dashboard/employee/assets/list' },
        { name: 'Dashboard', route: '/dashboard/employee/assets/dashboard' },
        { name: 'Asset Types', route: '/dashboard/employee/assets/types' },
        { name: 'Depreciation', route: '/dashboard/employee/assets/depreciation' }
      ]
    },
    { name: 'Calendar', icon: <Calendar size={18} />, route: '/dashboard/employee/calendar', hasSub: false },
    { name: 'Media Library', icon: <Image size={18} />, route: '/dashboard/employee/media-library', hasSub: false },
  ];
          ...
          {navItems.map((item, idx) => {
            ...
            return (
              <div key={idx} className="w-full relative">
                ...
                {/* Submenu map loop container with active indicator formatting */}
            ...
            <div className="relative" ref={dropdownRef}>
              <button onClick={() => setIsProfileOpen(!isProfileOpen)} className="flex items-center gap-3 cursor-pointer focus:outline-none group select-none">
                <div className="w-9 h-9 rounded-full bg-[#0da777]/10 border border-[#0da777]/20 flex items-center justify-center overflow-hidden transition-transform active:scale-95">
                  <span className="text-xs font-black text-[#0da777] uppercase">EM</span>
                </div>
              </button>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-3 w-64 bg-white border border-gray-100 rounded-2xl shadow-[0_10px_25px_rgba(0,0,0,0.05)] py-2 z-50 animate-fadeIn overflow-hidden">
                  <div className="px-5 py-3 border-b border-gray-50">
                    <h4 className="text-sm font-black text-gray-800 leading-none">Employee Workspace</h4>
